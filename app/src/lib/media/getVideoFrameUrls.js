...
export function getVideoFrameUrls(medium, count = DEFAULT_FRAME_COUNT, width = DEFAULT_FRAME_WIDTH) {
  ...
  return Array.from({ length: frameCount }, (_, index) => {
    ...
    return `https://image.mux.com/${playbackId}/thumbnail.jpg?time=${time.toFixed(2)}&width=${frameWidth}`;
  });
}
